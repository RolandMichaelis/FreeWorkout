...
public class FragmentStrength extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(wo_choose<0) {
            ...
            points=w.getStrength().getPoints();
            ...
            public void onClick(View v)
            {
                switch (v.getId()) {
                    case R.id.button_wo_display:
                        ...
                        String ListTextShadow = "0,"+String.valueOf(wo_choose)+",2,"+String.valueOf(quantity)+",-1,-1"; //Workout/Special,Workoutnummer,Type(Strth,Std,End.),Anzahl,checked_day,checked_pos -1 da nicht über Coach gewählt
