...
public class Matrix2018Activity extends Activity {

    public static final String LOG_TAG = Matrix2018Activity.class.getSimpleName();
...
/*        View v1 = new View(this);
        ...
        ll.addView(v1);*/
        int workoutCount = workoutNewPack.getWorkouts().size();
    ...
    public void dialog_choose(int rid) {
        ...
        WorkoutNew w = workoutNewPack.getWorkouts().get(n);
        String wName=w.getName();
        ...
        builder.setTitle(q+" x "+wName+Types[d])
                .setPositiveButton(R.string.dialog_button_start, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        Intent workoutFragmentIntent = new Intent(Matrix2018Activity.this, WorkoutActivity.class);
                        String ListTextShadow = "2,"+String.valueOf(n)+","+String.valueOf(d)+","+String.valueOf(q)+",-1,-1,0"; //Workout/Special,Workoutnummer,Type(Strth,Std,End.),Anzahl
